...
use App\Service\Dynamic\DynamicExtraExpensesProvider;
use Closure;
...
#[AsCommand(
    name: 'app:sync-data-over-network:dynamic',
    description: 'Add a short description for your command',
)]
class SyncDynamicDataOverNetworkCommand extends Command
{
    private const ITERATIONS = 10;

    public function __construct(
        private DynamicExtraExpensesProvider $expensesProvider
    ) {
        parent::__construct();
    }
